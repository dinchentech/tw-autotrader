...
3. ⏳ **排程 A 換股日賣出後重整總 alloc**（2026-09-05 記）：每月換股(高獲利) 5 檔 auto（PC_2464/1409/6197/2634/6214，各 5%）已入實盤 `.env`，目前 15 檔總 alloc **130.8% 超 100%** —— 待排程 A（2/5/8/11月）換股日賣出 keep_wait 檔（3017/3653/2059）釋出資金後，把總 alloc 回歸到 ~100%，並觀察 5 檔 auto 訊號實盤表現。
