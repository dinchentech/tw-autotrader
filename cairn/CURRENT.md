...
- **已持倉（保留, 依「已持倉不動」規則）**：3017/3653/2059(keep_wait, 全輪替) + **3008 大立光(breakout, 13股 @7,455)**。3008 維持 breakout、**不改 auto**（使用者決定，下月選股日再觀察）。
- **非輪替（模型C 每月自動選股, 正常）**：auto 5 檔 **2464 盟立 / 4967 十銓 / 2006 東和鋼鐵 / 3515 華擎 / 2362 藍天**，各 5%（=25%）。
- **現況（2026-09-05 重整）**：全輪替 keep_wait 65.1% + 3008 5% + 非輪替 auto 25% = **95.1%**（現金約 4.9%）。已依規則汰換舊固定(2360/6805/2884/2454/3189/6213)與未再選中的舊 auto(1409/6197/2634/6214)；2464 因仍被選中而保留、3008 因已持倉而保留。
- ⚠️ 觀察：非輪替改為「正常」選股(權值/平衡)、全輪替維持(動能/中小飆股)，兩腿互補；auto 型態感知由 live 每日路由。

> ⏳ **待辦（session 開啟請留意）**：`.env` 現 **9 檔**（3 全輪替 keep_wait + 3008 breakout(已持倉) + 5 檔 auto），總 alloc **95.1%**。**等排程 A 換股日賣出 keep_wait 檔釋資後**，斟酌全輪替/非輪替比例；**下一個選股日觀察**：3008 是否維持 breakout、5 檔 auto 訊號實盤表現。詳見 `cairn/ROADMAP.md` 開放問題 3。
