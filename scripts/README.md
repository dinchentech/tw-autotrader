...
- `catalyst_weight`：藥華藥模式權重（0 / 0.3 / 0.5 / 1.0）
...
| 流程 | 策略 | 2022→2025 終值 |
|------|------|---------------|
| **A｜純動能** 🥇 | 每季從固定 16 檔選近季動能最強 4 檔 | **NT$3,355,047 (+571%)** |
| B｜純催化劑 | 每季選藥華藥模式評分最高 4 檔 | NT$1,957,494 (+291%) |
| C｜動能+催化劑混合 | 先擴池再套動能 | NT$47,282（-90.5%） |
| D｜核心+衛星 | 80% 動能 + 20% 催化劑 | NT$3,267,566 (+553%) |
